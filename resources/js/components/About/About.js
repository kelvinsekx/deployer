        ...
        <div className="container-fluid about-page">
            <section className="row mb-5 anchor_statement center">
                ...
                <div className="col-lg-6 col-12 col-xs-12">
                    <p>
                        Our mission is to continually create <span className="forestvegi">environment</span>, and <span className="blue">sync</span>
                        knowledge and efforts with <span className="red">Love</span> that aims at improving and 
            ...
            <section className="row mt-2 d-flex justify-content-center text-muted">
                <div className="col">
                    <p>
